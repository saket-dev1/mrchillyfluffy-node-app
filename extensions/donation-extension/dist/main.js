...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // ../../node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/settings.mjs
  function useSettings() {
    var settings = useSubscription(useExtensionApi().settings);
    return settings;
  }
  ...
  render2("Checkout::DeliveryAddress::RenderBefore", () => /* @__PURE__ */ import_react9.default.createElement(App, null));
  function App() {
    console.log("sd");
    ...
    return /* @__PURE__ */ import_react9.default.createElement(Banner2, {
      title,
      status,
      collapsible
    }, description);
